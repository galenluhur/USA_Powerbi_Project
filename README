This semester, I completed an in-depth data visualization project using Power BI, where I designed 20 interactive dashboards. The dataset analyzed key metrics of U.S. cities, including:
